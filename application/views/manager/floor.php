					...
					<div class="row">
						<div class="col-md-12 m-bottom-10 m-top-10">
							<div class="pull-right">
								<a href="<?php echo base_url('manager/addFloor'); ?>" type="button" class="btn btn-warning m-top-10">Add Floor</a>
							...
							<table class="table table-striped" >
								...
								<tbody>
									...
									<tr>
										...
										<td><?php echo $info->floorTotalNumberUnit ?></td>
										<td><a href="<?php echo base_url("manager/viewFloor/{$info->floorId}"); ?>"><i class="fa fa-info-circle fa-2x" aria-hidden="true"></i></a></td>
									</tr>
									<?php }?> 
								</tbody>
							</table>
