<?php include('header.php') ?>
	<div class="row">
		<div class="col-md-12">
			<h3 class="page-header">Seat Type</h3>
		</div>
	</div>
	<div class="row">
      <div class="col-md-12">
					...
					<div class="row">
						<div class="col-md-12 m-bottom-10 m-top-10">
							<div class="pull-right">
								<a href="<?php echo base_url('manager/addSeatType'); ?>" type="button" class="btn btn-warning m-top-10">Add Seat Type</a>
							...
							<table class="table table-striped" >
								...
								<tbody>
									...
									<tr>
										...
										<td><?php echo $info->seatRentAmount ?></td>
										<td><a href="<?php echo base_url("manager/viewseatType/{$info->seatTypeId}"); ?>"><i class="fa fa-info-circle fa-2x" aria-hidden="true"></i></a></td>
									</tr>
									<?php } ?>
								</tbody>
							</table>
