<?php include('header.php') ?>
	<div class="row">
		<div class="col-md-12">
			<h3 class="page-header">Student History</h3>
		</div>
	</div>
	<div class="row">
      <div class="col-md-12">
							...
							<table class="table table-striped" >
								<thead>
									...
									<tr class="filters">											
										...
										<th>
											<input type="text" class="form-control" placeholder="Event" disabled>
										</th>
										<th>
											<span>View</span>
										</th>
								...
								<tbody>
									<tr>
										<td>2017</td>
										<td>event</td>
										<td><a href="<?php echo base_url('manager/viewStudentHistory'); ?>"><i class="fa fa-info-circle fa-2x" aria-hidden="true"></i></a></td>
									</tr>
								</tbody>
							</table>
						</div>
