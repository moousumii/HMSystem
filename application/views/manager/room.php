					...
					<div class="row">
						<div class="col-md-12 m-bottom-10 m-top-10">
							<div class="pull-right">
								<a href="<?php echo base_url('manager/addRoom'); ?>" type="button" class="btn btn-warning m-top-10">Add Room</a>
							...
							<table class="table table-striped" >
								<thead>
									...
									<tr class="filters">	
										...
										<th>
											<input type="text" class="form-control text-left" placeholder="Unit No." disabled data-toggle="true">
										</th>
										<th>
								...
								<tbody>
									...
									<tr>
										...
										<td><a href="<?php echo base_url("manager/viewRoom/{$info->roomId}"); ?>"><i class="fa fa-info-circle fa-2x" aria-hidden="true"></i></a></td>
									</tr>
									<?php }?> 
								</tbody>
							</table>
