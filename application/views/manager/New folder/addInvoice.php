				...
				<div class="panel-body card-shadow">
					<div class="row">
						<div class="col-md-3">
							<div class="form-group">
							    <label>Product</label>
							    <input type="text" id="productIdForInvoice" class="form-control ajaxInputField" name="" value="">
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
						...
						<div class="col-md-3">
							<div class="form-group">
							    <label>Rate</label>
							    <input type="text" id="productRateForInvoice" class="form-control ajaxInputField" name="" value="">
							</div>
						</div>	
						<div class="col-md-3">
							<div class="form-group">
							    <label>Special Rate</label>
							    <input type="text" class="form-control ajaxInputField" id="productSpecialRateForInvoice" name="" value="">
							</div>
						</div>	
					</div>
					<div class="row">
