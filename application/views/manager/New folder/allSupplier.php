<?php include('header.php') ?>
	<div class="row">
		<div class="col-md-12">
			<h3 class="page-header">All Suppliers</h3>
		</div>
	</div>
	<div class="row">
      <div class="col-md-12">
					...
					<div class="row">
						<div class="col-md-12 m-bottom-10 m-top-10">
							<div class="pull-right">
								<a href="<?php echo base_url('manager/addSupplier')?>" class="btn btn-warning m-top-20">Add New Supplier</a>
							...
							<table class="table table-striped">
								<thead>
									<tr class="active filters">
										<th>
											<input type="text" class="form-control" placeholder="Supplier ID" disabled data-toggle="true" id="">
										</th>
										<th>
