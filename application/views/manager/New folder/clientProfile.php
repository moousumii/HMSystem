<?php include('header.php') ?>
	<div class="row">
		<div class="col-md-12">
			<h3 class="page-header">Client Profile</h3>
		</div>
	</div>
	<div class="row">
      <div class="col-md-12">
	...
	<div class="row supplier-profile">
		<div class="col-md-12">
			<div class="panel panel-info">
				<?php echo form_open('manager/updateClient', 'class="clientDetailsFrom"') ?>
				...
				<div class="panel-footer">
					<div class="row m-bottom-25">
						<div class="col-md-12">
							<h3 class="text-center">Client Addresses</h3>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
	...
	<div class="row tranDetailsTable">
		<div class="col-md-12">
