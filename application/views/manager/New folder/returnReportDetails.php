	...
	<div class="row">
      <div class="col-md-12">
         <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('manager/returnReport');?>">Return Report</a> </li>
            <li class="active">Return Report Details</li>
         </ol>
      </div>
   </div>
	<div class="row">
			...
			<div class="thumbnail">
				<div class="caption">
					...
					<div class="row m-bottom-15">
						<div class="col-md-12">
							<h3 class="small-title">Returned Product Details</h3>
						</div>
					</div>
					...
					<div class="row m-bottom-15">
						<div class="col-md-12">
							<h3 class="small-title">Exchanged Product Details</h3>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-12">
							<a type="button" href="<?php echo base_url('manager/returnReport'); ?>" class="btn btn-danger">Back</a>
						</div>
					</div>					
				</div>
			</div>
