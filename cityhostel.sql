...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 24, 2017 at 11:26 PM
...
(1, '', 'Mr. Customer ', '01718508746', '2017-09-08', 'testing', 1, 1, -2620, 'no note . this field is only for kanthi ....', '2017-09-08 21:51:30', 9),
...
(1, 'Security Charge', 'Expense Details', 1, '2017-09-24 05:12:13');
...
INSERT INTO `expense_info` (`expenseID`, `expenceFieldID`, `expenceAmount`, `expenceDate`, `expenceReference`, `expenseNote`, `expenceEntryBy`, `shop_info_ExpenceShopID`) VALUES
...
INSERT INTO `product_info` (`productId`, `productName`, `productQuantity`, `productPurchasePrice`, `productSalePrice`, `productDetails`, `productUnitName`, `productTotalCost`, `productNote`, `product_type_info_productTypeID`, `supplier_info_productSupplierID`, `productSaleCounter`, `productStatus`, `productCommission`, `admin_info_productAdminID`, `productAddedDate`, `productUpdatedDate`, `productUpdatedBy`, `productVat`, `productDiscountAmount`, `productDiscountAddedDate`, `productDiscountEndDate`) VALUES
(1, 'new product', 13, 1400, 1500, 'product description 1 ', 'kg', 20000, 'note for product. 1', 1, 2, 2, 1, 0, 0, '2017-09-09 01:42:07', '2017-09-23 21:00:05', 9, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(3, 'lafarge Surma Cement', 7497, 6356.71, 690, 'Lafarge Cement', 'Sack', 47681687, 'Lafarge Cement', 2, 2, 4, 1, 0, 0, '2017-09-18 15:18:44', '2017-09-23 21:00:05', 9, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(4, 'BSRM Rod', 998, 5.45, 158940, 'BSRM Rod', 'Ton', 5445, 'BSRM Rod', 3, 2, 2, 1, 0, 0, '2017-09-18 15:26:53', '2017-09-22 16:11:45', 9, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
(1, 'Type-1', 'Product type details', 1, '2017-09-08 22:23:03'),
(2, 'Cement', 'ghor Bananor kaaje lage', 1, '2017-09-18 15:05:43'),
(3, 'Rod', 'Rod', 1, '2017-09-18 15:26:28');
...
--
ALTER TABLE `bill_info`
  MODIFY `billInfoId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `cash_account_info`
--
ALTER TABLE `cash_account_info`
  MODIFY `cashAccountInfoId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `expense_field_info`
  MODIFY `expenseFieldID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `transection_info`
  MODIFY `transectionID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `transection_type_info`
--
ALTER TABLE `transection_type_info`
  MODIFY `transactionTypeId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
